...
from PySide6.QtWidgets import (QDateEdit, QFrame, QGridLayout,
...
class Ui_widget(object):
    def setupUi(self, widget):
        ...
        sizePolicy.setHeightForWidth(self.periodResources.sizePolicy().hasHeightForWidth())
        self.periodResources.setSizePolicy(sizePolicy)
        self.periodResources.setMinimumSize(QSize(0, 0))
        ...
        sizePolicy4.setHeightForWidth(self.addPeriodResources.sizePolicy().hasHeightForWidth())
        self.addPeriodResources.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.removePeriodResources.sizePolicy().hasHeightForWidth())
        self.removePeriodResources.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.addStage.sizePolicy().hasHeightForWidth())
        self.addStage.setSizePolicy(sizePolicy4)
        ...
        sizePolicy6.setHeightForWidth(self.tabWidgetStages.sizePolicy().hasHeightForWidth())
        self.tabWidgetStages.setSizePolicy(sizePolicy6)
